...
const assets = {
    ...
    images: {
        ...
        misc: ['mapTrigger'],
        decoration: ['painting1', 'sofa1', 'sofa2', 'rug', 'meshDivider', 'flowerDisplay1', 'flowerDisplay2', 'flowerDisplay3',
            'furnace', 'barCart', 'bed1', 'sideTable1', 'sideTable2', 'flowerPot', 'floorLamp', 'window1', 'window2', 'window3',
            'window4', 'fridge', 'sink'],
